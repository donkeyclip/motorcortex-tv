...
var fails$7 = fails$b; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
...
var NoiseEffectPlugin = motorcortex.loadPlugin(NoiseEffectDef);
    ...
    value: function buildTree() {
      ...
      if (this.attrs.sound === true) {
        for (var i = 0; i < duration - 4000; i += 4000) {
          var sound = new motorcortex.AudioPlayback({
            selector: "~#static",
            duration: 4000
          });
        ...
        var leftoverSound = new motorcortex.AudioPlayback({
          selector: "~#static",
          duration: leftovers
        });
...
var CanvasClipPlugin = motorcortex.loadPlugin(canvasClipPluginDefinition);
